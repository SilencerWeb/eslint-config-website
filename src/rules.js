    ...
    options: [
      {
        ...
        defaultValue: "all",
        description: null,
        options: ["all", "multi", "multi-line", "multi-or-nest"],
      },
    ],
    value: "warn",
    category: "Best Practices",
    ...
    options: [
      {
        ...
        defaultValue: "always",
        description: null,
        options: ["always", "smart", "allow-null"],
      },
    ],
    value: "warn",
    category: "Best Practices",
    ...
    options: [
      {
        ...
        defaultValue: "never",
        description: null,
        options: ["never", "global", "function", "safe"],
      },
    ],
    value: "warn",
    ...
    options: [
      {
        ...
        defaultValue: "always",
        description: null,
        options: ["always", "never", "consistent"],
      },
    ],
    value: "warn",
    ...
    options: [
      {
        ...
        defaultValue: "1tbs",
        description: null,
        options: ["1tbs", "stroustrup", "allman"],
      },
      {
    ...
    options: [
      {
        ...
        defaultValue: "never",
        description: null,
        options: ["never", "always", "always-multiline", "only-multiline"],
      },
    ],
    value: "warn",
    category: "Stylistic Issues",
    ...
    options: [
      {
        ...
        defaultValue: "always",
        description: null,
        options: ["always", "never", "unix", "windows"],
      },
    ],
    value: "warn",
    category: "Stylistic Issues",
    ...
    options: [
      {
        ...
        description: null,
        options: ["expression", "declaration"],
      },
      {
    ...
    options: [
      {
        ...
        description: null,
        options: ["always", "never", "multiline", "consistent"],
      },
    ],
    value: "warn",
    category: "Stylistic Issues",
    ...
    options: [
      {
        ...
        description: null,
        options: ["prefer-single", "prefer-double"],
      },
    ],
    value: "warn",
    category: "Stylistic Issues",
    ...
    options: [
      {
        ...
        defaultValue: "",
        description:
          "Specifies a regular expression to ignore lines that match a pattern.",
        options: [],
      },
      {
    ...
    options: [
      {
        ...
        defaultValue: "3",
        description:
          "Specifies a maximum number of parameters in function definitions.",
        options: [],
      },
    ],
    value: "warn",
    ...
    options: [
      {
        ...
        defaultValue: "1",
        description:
          "Specifies a maximum number of statements allowed per line.",
        options: [],
      },
    ],
    value: "warn",
    ...
    options: [
      {
        ...
        description: null,
        options: ["starred-block", "separate-lines", "bare-block"],
      },
    ],
    value: "warn",
    category: "Stylistic Issues",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        defaultValue: "",
        description:
          "Specifies a regular expression to ignore lowercase-started function names that match a pattern.",
        options: [],
      },
      {
        ...
        defaultValue: "",
        description:
          "Specifies a regular expression to ignore uppercase-started function names that match a pattern.",
        options: [],
      },
      {
    ...
    options: [
      {
        ...
        defaultValue: "always",
        description: null,
        options: ["always", "never", "consecutive"],
      },
    ],
    value: "warn",
    category: "Stylistic Issues",
    ...
    options: [
      {
        ...
        description: null,
        options: ["always", "initializations"],
      },
    ],
    value: "warn",
    category: "Stylistic Issues",
    ...
    options: [
      {
        ...
        defaultValue: "after",
        description: null,
        options: ["after", "before", "none", "null"],
      },
    ],
    value: "warn",
    category: "Stylistic Issues",
